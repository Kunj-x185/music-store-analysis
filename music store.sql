...
--which city has best customers & write query that returns one city with highest sum
of invoice totals & return both city name & sum of all invoice totals--

select sum(total) as invoice_total, billing_city from invoice group by billing_city 
order by invoice_total desc

--who is the best customer, who spends most money(here we will join two tables)--
